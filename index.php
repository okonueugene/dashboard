                  ...
                  <div class="card-body pt-0">
                    <div class="row">
                      <div class="col-sm-4">
                        ...
                        <h5 class="font-size-15 text-truncate"><?php echo implode('', $user); ?></h5>
                        <p class="text-muted mb-0 text-truncate"><?php echo implode('', $site); ?></p>
                      </div>
                      ...
                      <div class="col-sm-8">
                        <div class="pt-4">
                          <div class="row">
                            <div class="col-6">
                              <h5 class="font-size-15"><?php echo implode('', $guards); ?></h5>
                              <p class="text-muted mb-0">Total Guards</p>
                            </div>
                            <div class="col-6">
                              <h5 class="font-size-15"><?php echo implode('', $patrols); ?></h5>
                              <p class="text-muted mb-0">Total patrols</p>
                            </div>
                          </div>
                          <div class="mt-4">
                            <a
                              href="https://staging.askari.optitech.co.ke/login"
                      ...
                      <div class="card-body">
                        <div class="d-flex">
                          <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0"><?php echo implode('', $elapsed); ?>/<?php echo implode('', $patrols); ?></h4>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="d-flex">
                          <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0"><?php echo implode('', $attendance); ?>/<?php echo implode('', $guards); ?></h4>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="d-flex">
                          <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0"><?php echo implode('', $completed); ?>/<?php echo implode('', $incomplete); ?></h4>
                          </div>
                          ...
                          <div class="flex-shrink-0 align-self-center">
                            ...
                            >
                              ...
                              >
                                <i
                                  class="bx bx-purchase-tag-alt font-size-24"
                                ></i>
                              </span>
                            </div>
                          </div>
                    ...
                    <div class="table-responsive mt-4" >
                      <table class="table align-middle table-nowrap">
                        <tbody>
                          ...
                          <tr>
                            <td style="width: 30%">
                              <p class="mb-0"> <?php echo $allguards[$record['guard_id']];?></p>
                            </td>
                            <td style="width: 25%">
                              <h5 class="mb-0"><?php   
                              //get time now
                              ...
                              // get diffrence between time now and time in
              ...
              <div class="col-lg-12">
                <div class="card">
                  ...
                  <div class="card-header">
                    <h4 class="card-title mb-4">Live Patrols  <span class="blink"><img src="http://cliparts.co/cliparts/6Tp/5aB/6Tp5aB97c.png" alt="" width="16" height="16"></span></h4>
                  </div>
                  <div class="card-body">
                    <table class="table table-info table-hover table-sm">
                      ...
                      <tr>
                      <td class="table-sm"><?php echo $allguards[$livepatrol['guard_id']]; ?></td>
                        <td class="table-sm"><?php echo $allsites[$livepatrol['site_id']]; ?></td>
                        ...
                        <td class="table-sm">
                          <span class="badge bg-success"><?php echo $livepatrol['status']; ?></span>
                        </td>
                      </tr>
                      <?php } ?>
                      </tbody>
...
// //chane between dark and light mode
...
// // initial call to set chart options based on localStorage value
// updateChartOptions();

// function updateChartOptions() {
//   var darkMode = localStorage.getItem('dark-mode');
//   var titleColor = darkMode === 'true' ? 'white' : '#263238';
